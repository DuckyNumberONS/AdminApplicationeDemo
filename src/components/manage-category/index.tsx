import { getDataCategorys } from '@/api/apiConfict';
...
const ManageCategory = () => {
    ...
    const handleDetails = (idCategory: number) => {
        path.push(`/list-category/list-movie-genre`);
    };

    return (
        <div className="flex flex-col space-y-2">
            <h2 className="font-medium text-2xl">List Category</h2>
                    ...
                    <div className="grid md:grid-cols-3 lg:grid-cols-3 sm:grid-cols-3 gap-4 bg-gray-50 px-6 py-3">
                        ...
                        {category.map((items) => (
                            <div
                                ...
                                style={{ backgroundColor: items.colorCategory }}
                                onClick={() => handleDetails(items.idCategory)}
                            >
                                <div className="mx-auto w-full h-[280px] flex items-center justify-center">
